"""
Django settings for softcole project.
...
SECRET_KEY = '+i$qm^z%psrj5#yu+h7s2a38j00d=gv!qq&8@6-p3figg2a^l('
...
WSGI_APPLICATION = 'softcole.wsgi.application'
